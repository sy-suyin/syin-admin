<template>
	<div class="layout">
		<div class="layout-aside layout-aside-mini">
			<div class="slider">
...
<style lang="scss">
	...
	.layout-aside-mini{
		...
		.menu-group-level-0 .menu-item-group{
		...
		&:hover{
			...
			/* .logo-title, .user-name, .menu-group-level-0 .menu-item-group, .menu-name, .menu-switch-icon{
