<?php
/**
 * @source https://github.com/ircmaxell/password_compat github password_hash兼容库
 * 
 * 使用 bcrypt 处理密码
 */
...
Class Bcrypt{
	 ...
	 */
	protected static function _strlen($binary_string) {
	 ...
	 */
	protected static function _substr($binary_string, $start, $length) {
